...
bool WaterShaderClass::Initialize(ID3D11Device* device, HWND hwnd) {
	...
	result = InitializeShader(device, hwnd, L".\\Data\\Shaders\\WaterVertexShader.hlsl", L".\\Data\\Shaders\\WaterPixelShader.hlsl");
	if (!result) {
		return false;
	}
...
bool WaterShaderClass::Render(ID3D11DeviceContext* deviceContext, int indexCount, DirectX::XMMATRIX worldMatrix, DirectX::XMMATRIX viewMatrix,
	DirectX::XMMATRIX projectionMatrix, DirectX::XMMATRIX reflectionMatrix,
...
bool WaterShaderClass::SetShaderParameters(ID3D11DeviceContext* deviceContext, DirectX::XMMATRIX worldMatrix, DirectX::XMMATRIX viewMatrix,
	DirectX::XMMATRIX projectionMatrix, DirectX::XMMATRIX reflectionMatrix,
