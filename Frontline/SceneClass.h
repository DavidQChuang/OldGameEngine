...
public:
	...
	inline bool RenderRect(TexturedRect*, XMMATRIX, XMMATRIX, XMMATRIX, int);

	inline bool RenderSpritesheet(TexturedSpritesheet*, XMMATRIX, XMMATRIX, XMMATRIX, int);
	inline bool RenderSpritesheet(TexturedSpritesheet*, int, XMMATRIX, XMMATRIX, XMMATRIX, int);
...
//  
inline bool SceneClass::RenderRect(TexturedRect* object, XMMATRIX matrix, XMMATRIX viewMatrix, XMMATRIX orthoMatrix, int shaderType) {
...
//  Renders a TexturedRect from the buffer using a shader and passing a translation matrix as the world matrix.
//
inline bool SceneClass::RenderSpritesheet(TexturedSpritesheet* object, XMMATRIX matrix, XMMATRIX viewMatrix, XMMATRIX orthoMatrix, int shaderType) {
	object->Render(sm_Direct3D->GetDeviceContext());
	switch (shaderType) {
	case H_2D_COLOR_SHADERTYPE:
		return sm_ShaderClass->m_ColorShader->Render(sm_Direct3D->GetDeviceContext(), object->GetIndexCount(), matrix, viewMatrix, orthoMatrix);
...
//  Renders a TexturedRect from the buffer using a shader and passing a translation matrix as the world matrix.
//
inline bool SceneClass::RenderSpritesheet(TexturedSpritesheet* object, int spriteNumber, XMMATRIX matrix, XMMATRIX viewMatrix, XMMATRIX orthoMatrix, int shaderType) {
