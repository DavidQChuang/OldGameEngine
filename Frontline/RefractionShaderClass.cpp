...
bool RefractionShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	result = InitializeShader(device, hwnd, L".\\Data\\Shaders\\RefractionVertexShader.hlsl", L".\\Data\\Shaders\\RefractionPixelShader.hlsl");
	if (!result) {
		return false;
	}
...
bool RefractionShaderClass::SetShaderParameters(ID3D11DeviceContext* deviceContext, DirectX::XMMATRIX worldMatrix, DirectX::XMMATRIX viewMatrix,
