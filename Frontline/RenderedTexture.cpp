...
void RenderedTexture::Resize(int width, int height) {
	m_imageWidth = width;
	m_imageHeight = height;
}

bool RenderedTexture::Initialize(ID3D11Device* device, int screenWidth, int screenHeight, int bitmapWidth, int bitmapHeight)
{
	bool result;
...
bool RenderedTexture::Render(ID3D11DeviceContext* deviceContext, int positionX, int positionY)
{
	bool result;
...
int RenderedTexture::GetIndexCount()
{
	return m_indexCount;
}
...
void RenderedTexture::ShutdownBuffers()
{
...
bool RenderedTexture::UpdateBuffers(ID3D11DeviceContext* deviceContext, int positionX, int positionY)
{
	...
	// First triangle. DirectX::XMFLOAT
...
void RenderedTexture::RenderBuffers(ID3D11DeviceContext* deviceContext)
{
	unsigned int stride;
	unsigned int offset;
