...
ColorTextureShader::ColorTextureShader() {
	m_vertexShader = 0;
	m_pixelShader = 0;
	m_layout = 0;
	m_matrixBuffer = 0;
...
ColorTextureShader::ColorTextureShader(const ColorTextureShader& other) {
}
...
bool ColorTextureShader::Initialize(ID3D11Device* device, HWND hwnd) {
	bool result;
...
void ColorTextureShader::Shutdown() {
...
bool ColorTextureShader::Render(ID3D11DeviceContext* deviceContext, int indexCount, XMMATRIX worldMatrix, XMMATRIX viewMatrix,
...
bool ColorTextureShader::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename) {
	HRESULT result;
...
void ColorTextureShader::ShutdownShader() {
...
void ColorTextureShader::OutputShaderErrorMessage(ID3D10Blob* errorMessage, HWND hwnd, WCHAR* shaderFilename) {
	char* compileErrors;
...
bool ColorTextureShader::SetShaderParameters(ID3D11DeviceContext* deviceContext, XMMATRIX worldMatrix, XMMATRIX viewMatrix,
	XMMATRIX projectionMatrix, ID3D11ShaderResourceView* texture) {
	HRESULT result;
...
void ColorTextureShader::RenderShader(ID3D11DeviceContext* deviceContext, int indexCount) {
