...
bool D3DClass::Initialize(int screenWidth, int screenHeight, bool vsync, HWND hwnd, bool fullscreen, float screenDepth, float screenNear) {
	...
	m_deviceContext->OMSetBlendState(blendState, NULL, 0xffffffff);
	...
	m_orthoMatrix = DirectX::XMMatrixOrthographicLH(800.0f, 600.0f, screenNear, screenDepth);
